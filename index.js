...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: because nestedFunction will look outside itself to find a variable if it cannot find it within itself which is kind of cute.
...
//  console.log(summation(4)); //tested for accuracy
